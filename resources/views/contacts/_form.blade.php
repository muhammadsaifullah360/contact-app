<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                    <input type="text" name="phone" value="{{ old('phone',$contact->phone) }}" id="phone" class="form-control @error('phone number') is-invalid @enderror">
                @error('phone number')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <label for="address"></label><textarea name="address"  value="{{ old('address',$contact->address) }}" id="address" rows="3" class="form-control @error('address') is-invalid @enderror"></textarea>
                @error('address')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
